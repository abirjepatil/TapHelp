...
public class MySQLAccess {
	...
	public String GetServices(String userName)
	{
		...
		String query="SELECT SERVICE_TYPE,TBL_SERVICE.SID, SERVICE_ID FROM TBL_SERVICE LEFT JOIN TBL_SERVICE_MAP ON TBL_SERVICE.SID=TBL_SERVICE_MAP.SID WHERE UID = "+UID;
		...
		try
		{
		  ...
		  ResultSet rs = stmt.executeQuery(query);
		  while(rs.next()){
			  JSON+="{\"SID\":\""+rs.getString("SID")+"\", \"SERVICENAME\":\""+rs.getString("SERVICE_TYPE")+"\", \"SERVICEID\" : \""+rs.getString("SERVICE_ID")+"\""+ "},";
		  }
	...
	/*@desc Adds Description to a Service.
	 *@author Abhishek Birjepatil
	 *@version 1.0 March 30th 2016
	 *@param ServiceId, Description
	 *@return true if user already exists 
	 * @throw SQL Exception
	 */
	
	public boolean AddDescription(String ServiceId, String description)
	{
		String query = "UPDATE TBL_SERVICE_MAP SET DESCRIPTION = \""+description+"\" WHERE SERVICE_ID="+ServiceId;
		Connection connection = null;
		System.out.println(query);
		try
		{
	...
	/*@desc Removes a Service Mapping and Service Details
	 *@param Service ID
	 *@author Abhishek Birjepatil
	 *@version 1.1 April 12th 2016
	 */
	public boolean DeleteService(String ServiceId)
	{
		
		String query = "DELETE FROM TBL_SERVICE_MAP WHERE SERVICE_ID="+ServiceId;
		Connection connection = null;
